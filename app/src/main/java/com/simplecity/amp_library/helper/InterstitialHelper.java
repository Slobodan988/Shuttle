package com.simplecity.amp_library.helper;
...
/**
 * Created by slobodanzdravkovic on 4/4/17.
 */
...
//                    mMediationAgent.initInterstitial(InterstitialHelper.this.activityInstance, EntryData.SUPER_SONIC_APP_ID, mUserIdd);
...
//    }
    ...
    private void loadGoogleAdmobInterstitial() {
        ...
        if(ad_mob_interstitialAd == null)
        {
            ...
            ad_mob_interstitialAd.setAdUnitId(EntryData.ADMOB_INTERSTITIAL);
    ...
    private void loadFacebookInterstitial() {
        ...
        FBInterstitialAd = new com.facebook.ads.InterstitialAd(this.activityInstance, EntryData.FACEBOOK_INTERSTITIAL);
...
//
    private void setListenersForFacebookInterstitial()
    {
        FBInterstitialAd.setAdListener(new com.facebook.ads.InterstitialAdListener() {
            ...
            public void onError(Ad arg0, AdError arg1) {
                ...
                LogToConsole("----> faceInterstitial  onError: " + arg1.getErrorMessage()
                );
            }
    ...
    public  void CallInterstitial(Activity actForPresentingInterstitial, String interstitialLocation) {
       ...
       // initializeAdMobContinueDialog(actForPresentingInterstitial);
        ...
        if(interstitialShown  || this.activityInstance == null || actForPresentingInterstitial == null)
        {
...
//            else
//            {
//                LogToConsole("Nije spreman admob");
//            }
//
//
//            if(true)
...
//            }
            ...
            if (faceInterstitialLoaded && FBInterstitialAd!=null )
            {
                //ShowAdMobContinueDialog();
...
//            }
        ...
        else if (interstitialLocation.equals(INTERSTITIAL_ON_RESUME) &&  (difference > MIN_TIME_BETWEEN_ADS))
        {
...
//            admobAdMobContinueDialog.setContentView(R.layout.entry_dialog);
//
...
//
//
////            View continueButton = admobAdMobContinueDialog.findViewById(R.id.continue_button);
////
